...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '부모님 폐렴, 왜 이렇게 위험한 걸까',
      body: '부모님이 기침을 며칠째 하시는데 "그냥 감기겠지" 하고 넘기고 계시진 않나요. 폐렴은 매년 국내 만 65세 이상 사망 원인 3위를 차지합니다. 젊은 사람에게는 항생제로 비교적 쉽게 낫는 병이지만, 면역력이 떨어진 노인에게는 입원율이 20~40%에 달하고 중증 폐렴의 경우 사망률이 30%를 넘기기도 합니다. 특히 당뇨, 만성폐쇄성폐질환(COPD), 심부전 같은 기저질환이 있으면 위험이 더 높아집니다. [[senior-vaccination|예방접종 가이드]]에서 전반적인 백신 일정도 확인해 보세요.',
    },
    {
      type: 'list',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '감기는 대부분 맑은 콧물, 재채기, 가벼운 기침이 주증상이며 3~7일 내에 호전됩니다. 폐렴은 누런 가래, 고열(또는 노인의 경우 저체온), 호흡 곤란, 가슴 통증이 동반되고 1주일 이상 호전되지 않습니다. 기침이 일주일 넘게 계속되거나 숨쉬기가 힘들어지면 반드시 병원을 방문하세요.',
    },
    {
