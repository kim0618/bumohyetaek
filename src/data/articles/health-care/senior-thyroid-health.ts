...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '노화 증상인지, 갑상선 문제인지 어떻게 구별할까요?',
      body: '피로하고 추위를 타고 살이 찌는 것 - 이 증상이 나이 때문인지, 갑상선 문제인지 구별하기 어렵습니다. 둘 다 비슷한 증상을 보이지만 원인과 대응이 완전히 다릅니다. 갑상선 기능 저하증은 갑상선에서 호르몬을 충분히 만들지 못해 신진대사 전반이 느려지는 질환입니다. 65세 이상 여성 10명 중 1~2명에서 발생하며, 노화 증상과 겹치다 보니 발견이 늦어지는 경우가 많습니다. 핵심 차이는 이겁니다. 노화는 갑자기 오지 않지만, 갑상선 기능 저하는 몇 달 사이에 급격하게 나빠지는 경향이 있습니다. 간단한 혈액 검사(TSH) 하나로 확인할 수 있고, [[national-health-checkup-guide|국가건강검진]]을 받을 때 함께 확인을 요청하는 것도 방법입니다.',
    },
    {
      type: 'list',
