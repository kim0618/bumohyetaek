  ...
  sections: [
    {
      ...
      body: '건강보험료는 줄일 수 없다고 생각하기 쉽지만, 실제로는 그렇지 않습니다. 소득과 재산이 기준 이하라면 자녀의 피부양자로 등록해 보험료를 0원으로 만들 수 있고, 65세 이상 저소득 어르신은 최대 30% 경감도 받을 수 있습니다. [[health-insurance-limit|본인부담상한제]]와 함께 확인해두면 의료비 전반의 부담을 크게 줄일 수 있습니다.',
    },
    {
      type: 'info',
    ...
    },
    {
      ...
      body: '피부양자 등록이 어렵다면 아래 경감 제도를 신청하세요. 65세 이상 저소득 경감: 연간 소득 100만 원 이하 + 재산 기준 충족 시 30% 경감. 농어촌 지역가입자: 22% 경감(농업·어업·임업 종사자). 도서·벽지 거주자: 50% 경감. 재난·재해 피해자: 일시적 경감(주민센터 신청). 장기 요양 필요자: 6개월 이상 입원 시 경감 신청 가능.',
    },
    {
      type: 'numbered-list',
      heading: '신청 방법',
    ...
    },
    {
      ...
      body: '퇴직 후 지역가입자 보험료가 직장가입자 시절보다 많이 오른다면 "임의계속가입" 제도를 활용하세요. 퇴직 후 최대 36개월간 직장가입자 보험료 수준으로 유지할 수 있습니다. 퇴직일로부터 2개월 이내에 신청해야 합니다. 신청 시에는 신분증, 건강보험료 납부 확인서, 소득·재산 증빙서류를 준비하세요. 신청 후 다음 달 보험료부터 경감이 적용됩니다. 문의: ☎ 1577-1000 (국민건강보험공단)',
    },
    {
      type: 'warning',
      heading: '의료 안내 사항',
