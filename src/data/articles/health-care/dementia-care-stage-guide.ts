...
const article: ContentItem = {
  ...
  sections: [
    ...
    },
    {
      type: 'info',
      heading: '치매 진행 단계 구분',
      body: '경도(초기): 일상 대부분 독립적, 기억력·판단력 저하 시작, CDR 0.5~1\n- 장기요양 인지지원등급 또는 등급 외 해당, 치매안심센터 서비스 이용 가능\n\n중등도(중기): 혼자 외출·식사·위생 관리 어려움, CDR 2\n- 장기요양 3~4등급, 방문요양·주야간보호 중심\n\n중증(말기): 일상생활 전면 의존, 대화·보행 어려움, CDR 3 이상\n- 장기요양 1~2등급, 요양원 입소 또는 24시간 재가 서비스\n\n문의: ☎ 1355(국민건강보험공단) 또는 ☎ 256개 치매안심센터(지역 보건소 내)',
    },
    {
      type: 'list',
