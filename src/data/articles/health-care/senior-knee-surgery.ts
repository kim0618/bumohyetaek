...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '계단을 내려갈 때마다 손잡이를 잡지 않으면 안 되는 지경이 됐을 때',
      body: '무릎 통증이 처음에는 조금씩 이어지다가 어느 순간 잠자리에서 뒤척일 때도 아프고, 평지를 걷는 것조차 힘들어지는 상황이 됩니다. 퇴행성 관절염(골관절염)이 말기 단계에 이르면 연골이 거의 닳아 뼈끼리 직접 부딪혀 극심한 통증과 보행 장애가 생깁니다. 이때 손상된 관절을 인공 재료로 교체하는 인공관절 수술을 고려합니다. 수술 전 6개월 이상 약물치료, [[senior-physical-therapy|재활치료]], 주사 치료 등 보존적 치료를 먼저 시행하고 효과가 없을 때 수술을 권장합니다. 비만은 무릎 관절에 과도한 부담을 주는 주요 위험 요인입니다.',
    },
    {
      type: 'info',
  ...
  faq: [
    ...
    {
      question: '수술비 외에 비급여 항목이 얼마나 나올 수 있나요?',
      answer:
        '건강보험 급여 대상이 아닌 비급여 항목으로는 특실 입원비, 일부 고가 임플란트 재료, 수술 후 특정 보조기 등이 있습니다. 병원에 따라 수십만 원에서 수백만 원의 차이가 날 수 있습니다. 실손의료보험에 가입되어 있다면 비급여 항목의 일부 또는 전부를 보장받을 수 있으니 수술 전 보험사에 확인하세요. 의료비 상담은 국민건강보험공단 ☎ 1577-1000으로 문의하세요.',
    },
    {
      question: '인공관절 수술 후 운동이나 등산을 해도 되나요?',
      answer:
        '수술 후 6개월~1년이 지나 회복이 충분히 이뤄지면 걷기, 수영, 자전거 타기 같은 저충격 운동은 권장됩니다. 다만 달리기, 등산처럼 관절에 강한 충격이 가는 운동은 인공관절 마모를 가속시킬 수 있어 일반적으로 제한됩니다. 담당 의사의 지시에 따라 단계적으로 활동량을 늘리는 것이 좋습니다.',
    },
  ],
  ...
  relatedSlugs: ['rehabilitation-insurance', 'senior-checkup-surgery-guide', 'health-insurance-limit'],
};
