...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '호스피스, 치료를 그만두는 게 아닙니다',
      body: '"호스피스에 들어간다"는 말을 처음 들으면 "치료를 그만두라는 뜻인가요?"라고 묻는 가족이 많습니다. 사실은 정반대에 가깝습니다. 호스피스-완화의료는 완치를 목적으로 하는 적극적 치료가 더 이상 효과가 없는 말기 환자에게 통증과 증상을 조절하고, 심리적·영적 지원을 제공하는 전문 의료 서비스입니다. 환자뿐 아니라 가족의 심리 상담과 사별 후 돌봄까지 포함합니다. "포기"가 아니라 "남은 시간을 편안하고 존엄하게 보내기 위한 선택"이라는 표현이 더 정확합니다.',
    },
    {
      type: 'list',
      heading: '대상 질환 (담당 의사가 말기·임종기 판단 시 의뢰 가능)',
      items: [
        '말기 암',
        '후천성면역결핍증(AIDS)',
        '만성폐쇄성호흡기질환(COPD)',
  ...
  faq: [
    ...
    {
      question: '호스피스 신청 후 며칠 내에 입원할 수 있나요?',
      answer:
        '대기 기간은 기관마다 차이가 큽니다. 입원형 호스피스 병동은 수도권 인기 기관의 경우 1~3주 대기가 발생할 수 있고, 가정형이나 자문형은 비교적 빠르게 시작할 수 있습니다. 환자 상태가 위급한 경우 우선 배정을 요청할 수 있으므로 의뢰서에 그 사실을 명시하도록 담당 의사에게 부탁하세요. 중앙호스피스센터(☎ 1899-1234)에서 대기 기간이 짧은 기관을 안내받을 수도 있습니다.',
    },
  ],
