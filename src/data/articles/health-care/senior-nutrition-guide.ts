...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '많이 안 먹어도 영양은 괜찮겠지, 그 생각이 위험합니다',
      body: '식사량이 줄었는데 체중은 그대로니 괜찮다고 생각하기 쉽습니다. 하지만 나이가 들수록 같은 열량이라도 단백질·칼슘·비타민D 같은 필수 영양소가 부족해지기 쉬운 구조입니다. 근육이 줄어드는 근감소증은 적게 먹어서가 아니라 영양 구성이 잘못된 것이 원인인 경우가 많습니다. [[senior-fall-prevention|낙상]] 예방과 회복력 유지를 위해 필수 영양소를 챙기는 방법과, 식사 준비가 어려운 분들을 위한 무료 급식·배달 서비스를 안내합니다.',
    },
    {
      type: 'list',
  ...
  faq: [
    ...
    {
      question: '혼자 드시는 어르신에게 간단하면서 단백질이 많은 식품은 무엇인가요?',
      answer:
        '달걀은 삶거나 스크램블로 조리하기 쉽고 1개당 단백질 약 6g이 들어 있어 매끼 1개씩 먹는 것이 좋습니다. 두부 반 모에도 단백질 약 10g이 들어 있으며 부드러워 씹기 편합니다. 통조림 고등어·참치는 별도 조리 없이 바로 먹을 수 있어 편리합니다. 인스턴트 식품을 고를 때는 단백질 함량을 확인하고 염분이 낮은 것을 선택하세요.',
    },
  ],
