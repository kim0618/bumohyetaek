  ...
  sections: [
    {
      type: 'text',
      heading: '치매안심센터란?',
      body: '치매안심센터는 치매 국가책임제에 따라 전국 보건소 내에 설치된 치매 전담 기관입니다. 치매 조기 검진부터 환자 등록·관리, 가족 지원까지 치매 관련 서비스를 한 곳에서 받을 수 있습니다. [[senior-cognitive-screening|인지 선별 검사]]를 포함한 다양한 프로그램이 운영됩니다.',
    },
    {
      type: 'info',
      heading: '주요 제공 서비스',
    ...
    },
    {
      type: 'info',
      heading: '처리 기간',
      body: '방문 당일 기본 검사가 가능합니다. 정밀 검사는 예약 후 진행됩니다. 문의: ☎ 129 (보건복지상담센터) 또는 가까운 치매안심센터',
    },
  ],
