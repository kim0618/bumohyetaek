...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '부모님이 갑자기 한쪽 몸이 따끔하다고 하신다면?',
      body: '부모님이 갑자기 한쪽 가슴이나 등이 따끔거린다고 하신다면 대상포진을 먼저 의심해보세요. 만 50세 이상 성인의 약 30%가 평생 한 번은 대상포진을 경험하며, 80세까지 범위를 넓히면 절반 가까이 올라갑니다. 어린 시절 수두를 앓고 나면 바이러스가 신경절에 잠복해 있다가 면역력이 약해지는 고령에 다시 활성화됩니다. 수포가 나타난 뒤 72시간이 치료의 골든타임이므로, 증상이 의심되면 당일 병원 방문을 도와드리세요. [[senior-vaccination|예방접종 가이드]]에서 전반적인 백신 일정도 함께 확인해 보세요.',
    },
    {
      type: 'list',
