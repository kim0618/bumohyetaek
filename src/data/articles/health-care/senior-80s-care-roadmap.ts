...
const article: ContentItem = {
  ...
  seoDescription:
    '80세를 넘으면 치매·낙상·입원이 급격히 늘어납니다. 장기요양 신청, 연명의료 의향서, 성년후견, 유언장까지 가족이 지금 당장 해야 할 일을 순서대로 미리 준비해 두세요.',
  ...
  summary:
    '80세 이후에는 치매·낙상·폐렴 위험이 크게 높아지고, 법적·재정적 준비 없이 위기 상황을 맞으면 가족 전체가 혼란에 빠질 수 있습니다. 장기요양 신청, 연명의료 의향서, 위임장, 유언장 등 지금 당장 챙겨야 할 것들을 단계별로 가족과 함께 챙기세요.',
