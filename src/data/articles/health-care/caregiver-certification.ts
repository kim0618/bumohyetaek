...
const article: ContentItem = {
  ...
  sections: [
    {
      ...
      body: '부모님이 장기요양 수급자로 인정받았는데, 가족이 직접 돌보면서 급여도 받을 수 있다는 말을 들으셨나요? 요양보호사 자격증이 있으면 가능합니다. 노인장기요양보험법에 따라 수급자 가족이 자격증을 취득하면 가족요양급여를 청구할 수 있고, 일반 돌봄 현장에서 취업할 수도 있습니다. 재가요양기관, 노인요양시설, 치매전담형 요양시설 등이 주요 근무지입니다. [[care-type-selection|요양서비스 유형]]을 함께 파악해두면 실제 돌봄 계획을 세우는 데 도움이 됩니다.',
    },
    {
      type: 'numbered-list',
      heading: '자격증 취득 절차',
    ...
    },
    {
      type: 'tip',
      heading: '취업 연계와 처우',
      body: '요양보호사 자격증 취득 후 재가요양기관이나 노인요양시설에 취업할 수 있습니다. 처우 개선 정책에 따라 요양보호사 기본급과 처우 개선비가 지속 인상되고 있습니다. 한국장기요양기관협회, 지역 노인복지관 취업 지원센터, 워크넷(www.work.go.kr) 등에서 구인 정보를 찾을 수 있습니다. [[home-visiting-care|재가 방문요양]] 서비스 종류도 함께 파악해두면 취업에 도움이 됩니다.',
    },
    {
      type: 'warning',
      heading: '의료 안내 사항',
  ...
  faq: [
    ...
    {
      question: '자격증 취득 후 취업하면 월 급여는 어느 정도 되나요?',
      answer:
        '재가요양기관 요양보호사의 경우 시간제 근무가 많으며, 주 40시간 기준 월 200만 원대 수준이 일반적입니다. 처우 개선 정책에 따라 처우 개선비가 별도 지급되며 지속적으로 인상되는 추세입니다. 노인요양시설 상근직은 고정 급여 체계로 운영되며, 지역·시설 규모에 따라 차이가 있습니다. 정확한 급여 정보는 워크넷(work.go.kr) 구인 공고에서 확인하세요.',
    },
  ],
