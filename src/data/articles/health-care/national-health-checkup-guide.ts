...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '국가건강검진이란?',
      body: '갑자기 부모님이 병원에서 "당뇨 전단계"라는 말을 처음 들었을 때, 혹은 혈압이 높다는 결과를 받았을 때 - 그때서야 건강검진을 더 일찍 챙겼더라면 하는 후회가 밀려옵니다. 국가건강검진은 이런 상황을 예방하기 위해 건강보험 가입자와 피부양자 모두에게 2년마다 무료로 제공하는 제도입니다. [[cancer-screening-guide|암 검진]]과 [[senior-vaccination|무료 예방접종]]도 함께 챙겨두면 더욱 효과적입니다.',
    },
    {
      type: 'info',
      heading: '검진 대상 확인 방법',
  ...
  faq: [
    ...
    {
      question: '직장가입자와 지역가입자의 검진 방법이 다른가요?',
      answer:
        '대상 기준은 동일하게 2년마다 한 번(홀수·짝수 출생연도 구분)이지만, 안내 방식이 조금 다릅니다. 직장가입자는 사업장을 통해 검진 안내를 받기도 하며, 지역가입자는 매년 1월 건강보험공단에서 우편으로 안내문을 발송합니다. 본인이 검진 대상인지 확인하려면 국민건강보험공단 앱(The건강보험) 또는 ☎ 1577-1000에 문의하면 즉시 확인할 수 있습니다.',
    },
  ],
  ...
  relatedSlugs: ['health-checkup-private-vs-national', 'long-term-care-grade', 'cancer-screening-guide', 'senior-hearing-aid', 'regional-health-checkup-support', 'senior-anemia-management'],
