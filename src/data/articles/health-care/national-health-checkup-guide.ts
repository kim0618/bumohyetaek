...
const article: ContentItem = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '대상 기준은 동일하게 2년마다 한 번(홀수·짝수 출생연도 구분)이지만, 안내 방식이 조금 다릅니다. 직장가입자는 사업장을 통해 검진 안내를 받기도 하며, 지역가입자는 매년 1월 건강보험공단에서 우편으로 안내문을 발송합니다. 본인이 올해 검진 대상인지 확인하려면 국민건강보험공단 앱(The건강보험) 또는 ☎ 1577-1000에 문의하면 즉시 확인할 수 있습니다.',
    },
  ],
