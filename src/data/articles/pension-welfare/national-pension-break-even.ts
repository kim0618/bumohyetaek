...
const article: ContentItem = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: '조기노령연금은 한번 신청하면 수령액이 영구 감액됩니다. 나중에 "더 받을걸"이라고 후회해도 취소가 되지 않습니다. 또한 조기수령 기간 중 소득이 국민연금 A값(2026년 약 309만원)을 초과하면 연금 지급이 정지됩니다. 재취업 계획이 있다면 미리 국민연금공단(☎ 1355)에 문의하세요.',
    },
    {
      type: 'summary',
      heading: '한눈에 정리',
