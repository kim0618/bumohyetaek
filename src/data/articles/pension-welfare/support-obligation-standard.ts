...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '주민센터에서 "자녀 때문에 안 된다"는 말을 들으셨다면',
      body: '주민센터에서 "자녀 소득이 있어 수급 자격이 안 된다"는 말을 듣고 돌아오신 적이 있다면, 지금 다시 신청해야 할 수도 있습니다. 부양의무자 기준은 기초생활보장 수급자 선정 시 본인뿐 아니라 자녀(1촌 직계혈족과 그 배우자)의 소득·재산까지 고려하던 제도였는데, 2022년부터 생계급여에서는 이 기준이 폐지되었기 때문입니다. 과거에 탈락한 분이라도 변경된 기준으로 다시 심사받을 수 있으니, [[basic-livelihood-benefit|기초생활수급]] 안내를 함께 확인하고 재신청을 검토해 보세요.',
    },
    {
      type: 'info',
  ...
  faq: [
    ...
    {
      question: '자녀가 부양을 거부할 때 어떤 서류로 증명하나요?',
      answer:
        '주민센터에서 "부양 거부·기피 사유서"를 작성해 제출합니다. 자녀와 가정폭력·학대·유기 사유로 인연이 끊긴 경우, 가출이나 행방불명 사례, 자녀가 직접 부양 거부 의사를 밝힌 경우 모두 인정 사유에 해당합니다. 객관적 자료(가족 진술서, 경찰 신고 기록 등)가 있으면 심사가 빨라지며, 자세한 절차는 ☎ 129(보건복지상담센터) 또는 거주지 주민센터에서 안내받을 수 있습니다.',
    },
  ],
