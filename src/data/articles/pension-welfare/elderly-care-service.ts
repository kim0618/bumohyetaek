  ...
  sections: [
    {
      type: 'text',
      heading: '노인맞춤돌봄서비스란?',
      body: '노인맞춤돌봄서비스는 일상생활 영위가 어려운 취약 노인에게 적절한 돌봄 서비스를 제공해 안정적인 노후를 지원하는 사회서비스입니다. 2020년 기존 6개 노인 돌봄 사업을 통합해 운영 중입니다. [[senior-welfare-center|노인복지관]]이나 지역 사회서비스 기관과 연계해 다양한 프로그램을 함께 이용할 수 있습니다.',
    },
    {
      type: 'info',
      heading: '서비스 대상',
