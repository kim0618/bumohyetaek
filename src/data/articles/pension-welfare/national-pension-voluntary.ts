...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '국민연금, 직장이 없어도 가입할 수 있습니다',
      body: '국민연금공단에 따르면 2024년 기준 임의가입자 수는 약 34만 명입니다. 전업주부, 사업 폐업 후 소득이 없는 분, 학생까지 다양한 이유로 자발적으로 국민연금을 납부하고 있습니다. 의무가입 대상이 아닌 사람도 만 18세 이상 60세 미만이라면 임의가입으로 국민연금에 가입할 수 있습니다. 가입 기간이 늘어날수록 나중에 받는 노령연금이 많아지므로, 경력이 단절된 기간에도 납부를 유지하는 것이 장기적으로 유리합니다. [[national-pension-timing|국민연금 수급 시기 안내]]를 함께 참고하면 전략을 세우는 데 도움이 됩니다.',
    },
    {
      type: 'info',
      heading: '임의가입 대상자',
