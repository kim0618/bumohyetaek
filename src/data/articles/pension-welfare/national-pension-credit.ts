...
const article: ContentItem = {
  ...
  seoTitle: '국민연금 크레딧 - 출산 50개월·군복무 6개월 가입기간 추가 받는 방법',
  seoDescription: '둘째 아이 출산 시 최대 50개월, 군복무 시 최대 6개월의 국민연금 가입 기간을 추가로 인정받을 수 있는 크레딧 제도. 자동 반영 조건과 신청 방법, 예상 수령액 증가분을 함께 살펴봅니다.',
