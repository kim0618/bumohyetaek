...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '결론부터 - 만 65세 이상이면 대부분 신청 가능',
      body: '결론부터 말하면, 만 65세 이상이거나 기준 중위소득 160% 이하라면 노인 사회서비스 바우처 중 하나 이상은 거의 다 받을 수 있습니다. 전자바우처는 정부가 대상자에게 현금 대신 서비스 이용권(바우처)을 지급하고, 지정된 기관에서 서비스를 받은 뒤 바우처로 결제하는 방식입니다. 제공기관은 사회서비스 전자바우처 포털(socialservice.or.kr)에서 검색할 수 있고, 노인 대상 주요 바우처는 크게 생활지원형과 돌봄형으로 나뉩니다. 기초생활수급자나 차상위계층이라면 추가로 받을 수 있는 혜택이 많으므로 [[basic-livelihood-benefit|기초생활보장 수급 안내]]도 함께 확인하세요.',
    },
    {
      type: 'list',
