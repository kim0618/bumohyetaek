...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '결론부터 - 만 65세 이상이면 신청 가능한 바우처가 있습니다',
      body: '결론부터 말하면, 만 65세 이상이라면 노인맞춤돌봄서비스처럼 소득과 무관하게 신청할 수 있는 바우처가 있고, 저소득 취약계층은 추가 서비스도 받을 수 있습니다. 전자바우처는 정부가 대상자에게 현금 대신 서비스 이용권(바우처)을 지급하고, 지정된 기관에서 서비스를 받은 뒤 바우처로 결제하는 방식입니다. 제공기관은 사회서비스 전자바우처 포털(socialservice.or.kr)에서 검색할 수 있고, 노인 대상 주요 바우처는 크게 생활지원형과 돌봄형으로 나뉩니다. 기초생활수급자나 차상위계층이라면 추가로 받을 수 있는 혜택이 많으므로 [[basic-livelihood-benefit|기초생활보장 수급 안내]]도 함께 확인하세요.',
    },
    {
      type: 'list',
    ...
    },
    {
      type: 'info',
      heading: '본인부담금 수준 안내',
      body: '사회서비스 바우처 본인부담금은 소득 수준에 따라 차등 적용됩니다. 기초생활수급자는 무료이거나 매우 적은 금액(시간당 300~600원)을 부담합니다. 차상위계층은 시간당 500~900원 수준이며, 일반 대상자(차상위 초과~기준 중위소득 70% 이하)는 시간당 1,000~1,500원 정도입니다. 정확한 본인부담금은 서비스 신청 시 담당자에게 확인하거나 ☎ 129(보건복지상담센터)로 문의하세요. 서비스 한도를 초과한 비용은 전액 본인 부담입니다.',
    },
    {
      type: 'tip',
