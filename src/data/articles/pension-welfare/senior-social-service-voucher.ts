...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '결론부터 - 만 65세 이상이면 받을 수 있는 돌봄 바우처가 있습니다',
      body: '결론부터 말하면, 만 65세 이상이라면 노인맞춤돌봄서비스 같은 돌봄 바우처를 신청할 수 있습니다. 다만 노인맞춤돌봄서비스는 기초생활수급자·차상위계층·기초연금 수급자 중 돌봄이 필요한 어르신이 대상으로 소득 기준이 있습니다. 기초연금 수급자(소득 하위 70%)까지 포함되어 대상이 넓은 편입니다. 전자바우처는 정부가 대상자에게 현금 대신 서비스 이용권(바우처)을 지급하고, 지정된 기관에서 서비스를 받은 뒤 바우처로 결제하는 방식입니다. 제공기관은 사회서비스 전자바우처 포털(socialservice.or.kr)에서 검색할 수 있고, 노인 대상 주요 바우처는 크게 생활지원형과 돌봄형으로 나뉩니다. [[basic-livelihood-benefit|기초생활보장 수급 안내]]도 함께 확인하세요.',
    },
    {
      type: 'list',
    ...
    },
    {
      type: 'info',
      heading: '본인부담금 수준 안내',
      body: '사회서비스 바우처 본인부담금은 서비스 유형과 소득 수준에 따라 다릅니다. 가사간병방문지원사업(서비스 단가 시간당 17,800원)을 예로 들면, 기초생활수급자·차상위계층은 A형(월 24시간)에서 본인부담이 면제되고, B형(월 27시간)은 월 14,420원을 부담합니다. 기준 중위소득 70% 이하 대상자는 A형 월 25,630원, B형 월 28,840원입니다. 즉 시간당이 아니라 이용 유형별 월 정액 구조입니다. 정확한 본인부담금은 서비스 신청 시 담당자에게 확인하거나 ☎ 129(보건복지상담센터)로 문의하세요. 서비스 한도를 초과한 비용은 전액 본인 부담입니다.',
    },
    {
      type: 'tip',
  ...
  relatedSlugs: ['long-term-care-grade', 'basic-livelihood-benefit'],
};
