...
const article: ContentItem = {
  ...
  seoDescription: '국민연금을 일찍 받으면 손해일까요? 조기노령연금과 연기연금의 차이, 손익분기점 계산법, 나에게 맞는 수령 시기 선택 기준을 부모님 상황별로 비교해 보세요.',
  ...
  summary:
    '국민연금은 언제 받느냐에 따라 총 수령액이 크게 달라집니다. 조기수령(최대 5년 일찍, 월 6% 감액)과 연기수령(최대 5년 연기, 월 7.2% 증액)의 손익분기점과 선택 기준을 한눈에 비교했습니다.',
  heroDescription:
  ...
  sections: [
    {
      ...
      body: '결론부터 말하면, 조기수령이 유리한 사람과 연기수령이 유리한 사람은 분명히 다릅니다. 당장 소득이 없고 건강이 좋지 않다면 일찍 받는 것이 낫고, 다른 소득이 있고 건강한 편이라면 늦게 받을수록 총 수령액이 늘어납니다. 조기수령은 최대 5년 일찍 받는 대신 1년당 6%씩 줄어들고, 연기수령은 최대 5년 늦게 받는 대신 1년당 7.2%씩 늘어납니다. [[basic-pension-application|기초연금]]과 달리 수령 시기 선택이 총 수령액을 수십 퍼센트까지 좌우합니다.',
    },
    {
      type: 'summary',
    ...
    },
    {
      ...
      body: '조기수령은 정해진 시기보다 최대 5년 일찍 연금을 받는 방식입니다. 1년 앞당길 때마다 6%씩 감액되어 5년 일찍 받으면 30% 줄어든 금액을 평생 받습니다.',
    },
    {
      type: 'list',
      items: [
    ...
    {
      type: 'list',
      heading: '연기수령이 유리한 경우 (1년 연기당 7.2% 증액, 최대 5년 36% 증액)',
      items: [
    ...
    },
    {
      ...
      body: '국민연금공단 홈페이지(nps.or.kr) 또는 내 곁에 국민연금 앱에서 본인의 예상 수령액과 수령 시기별 금액을 직접 확인할 수 있습니다. 결정 전에 개인별 시뮬레이션을 해보시기 바랍니다.',
    },
    {
      type: 'warning',
  ...
  faq: [
    ...
    {
      question: '개인별 예상 수령액은 어디서 확인할 수 있나요?',
      answer: '국민연금공단 홈페이지(nps.or.kr) 또는 내연금 알아보기 서비스(csa.nps.or.kr)에서 로그인 후 조기수령·정상수령·연기수령 시나리오별 예상 수령액을 직접 비교할 수 있습니다. 국민연금공단 콜센터(☎ 1355)에 전화하면 상담원이 개인 가입 이력을 바탕으로 시뮬레이션 결과를 직접 안내해줍니다. 결정을 내리기 전에 반드시 본인 수치를 확인하고 비교해 보세요.',
    },
  ],
  ...
  relatedSlugs: ['national-pension-break-even', 'national-pension-old-age-claim', 'basic-pension-application', 'housing-pension', 'survivor-pension', 'retirement-income-strategy', 'pension-income-tax', 'national-pension-reform-2026', 'retirement-finance-timeline', 'nps-retirement-readiness-service'],
