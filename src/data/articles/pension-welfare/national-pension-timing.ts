...
const article: ContentItem = {
  ...
  relatedSlugs: ['national-pension-break-even', 'basic-pension-application', 'housing-pension', 'survivor-pension', 'retirement-income-strategy', 'pension-income-tax', 'national-pension-reform-2026', 'retirement-finance-timeline'],
