...
const article: ContentItem = {
  ...
  relatedSlugs: ['national-pension-break-even', 'basic-pension-application', 'housing-pension', 'survivor-pension', 'pension-tax-benefit-guide', 'national-pension-reform-2026', 'retirement-preparation-checklist-guide'],
