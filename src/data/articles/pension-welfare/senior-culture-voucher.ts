...
const article: ContentItem = {
  ...
  faq: [
    {
      ...
      answer: '문화누리카드는 수급자 본인이 사용해야 합니다. 단, 자녀가 동행하여 어르신이 이용하는 시설이나 서비스 비용을 결제하는 것은 허용됩니다. 카드 잔액 확인이나 가맹점 검색은 자녀가 대신 앱으로 도와줄 수 있습니다. 문의: ☎ 1544-3412',
    },
    {
  ...
  relatedSlugs: ['basic-livelihood-benefit', 'low-income-benefit-comparison-guide', 'senior-discount-legal-support-guide'],
};
