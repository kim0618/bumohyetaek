...
const article: ContentItem = {
  ...
  relatedSlugs: ['turning-65-benefit-guide', 'national-pension-timing', 'senior-discount-legal-support-guide', 'housing-pension', 'national-pension-receiving-strategy-guide'],
