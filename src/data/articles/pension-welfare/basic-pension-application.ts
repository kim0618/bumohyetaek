...
const article: ContentItem = {
  ...
  relatedSlugs: ['turning-65-benefit-guide', 'national-pension-timing', 'senior-discount-guide', 'housing-pension', 'nps-retirement-readiness-service', 'special-occupation-pension-basic-pension'],
