...
const article: ContentItem = {
  ...
  relatedSlugs: ['ltci-not-eligible-alternatives', 'ltci-application-timing-guide', 'ltci-cost-simulation', 'ltci-bath-nursing-service', 'ltci-short-term-care', 'basic-pension-vs-ltci-criteria-comparison'],
  relatedCalculator: {
