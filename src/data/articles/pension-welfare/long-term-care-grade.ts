...
const article: ContentItem = {
  ...
  relatedSlugs: ['ltci-not-eligible-alternatives', 'ltci-application-timing-guide', 'ltci-cost-simulation', 'dementia-5year-cost-simulation', 'ltci-short-term-care', 'basic-pension-vs-ltci-criteria-comparison'],
  relatedCalculator: {
