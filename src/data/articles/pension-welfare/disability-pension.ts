...
const article: ContentItem = {
  ...
  sections: [
    ...
    },
    {
      type: 'info',
      heading: '지급 금액',
      body: '장애인연금은 기초급여와 부가급여로 구성됩니다. 기초급여는 소득 보장을 위한 것으로 [[basic-pension-application|기초연금]]과 동일한 금액(최대 월 349,700원)이며, 부가급여는 장애로 인한 추가 비용을 보전하기 위한 것으로 수급 유형에 따라 월 2만~9만 원이 추가됩니다. 기초생활수급자인 경우 부가급여가 가장 높습니다.',
    },
    {
      type: 'warning',
    ...
    },
    {
      ...
      items: [
        ...
        '기초급여(최대 월 349,700원) + 부가급여(월 2~9만 원) 구성',
