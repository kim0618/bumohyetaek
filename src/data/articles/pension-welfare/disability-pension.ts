...
const article: ContentItem = {
  ...
  seoDescription: '중증 장애인이라면 장애인연금으로 매월 최대 약 44만 원을 받을 수 있습니다. 장애인연금과 장애수당 차이, 수급 자격, 기초연금 중복 여부, 신청 방법을 안내합니다.',
  ...
  keyPoints: [
    ...
    '기초급여 최대 월 349,700원 + 부가급여 최대 약 9만 원',
  ...
  sections: [
    {
      type: 'text',
      heading: '중증 장애인이라면 매월 최대 약 44만 원 수령 가능',
      body: '결론부터 말하면, 만 18세 이상 중증 장애인이면서 소득인정액 기준을 충족하면 장애인연금으로 매월 최대 약 44만 원을 받을 수 있습니다. 2010년에 도입된 이 제도는 장애로 인해 근로 능력이 제한된 분들의 소득을 보장합니다. [[disability-registration|장애인 등록]]을 마친 뒤 주민센터에서 신청하면 됩니다. 기초급여와 부가급여로 나뉘며, 구체적인 금액과 자격 조건을 아래에서 정리했습니다.',
    },
    {
      type: 'info',
      heading: '장애인연금 vs 장애수당 차이',
      body: '장애인연금은 장애 정도가 심한 중증 장애인에게 지급되며, 장애수당은 장애 정도가 심하지 않은 경증 장애인 중 기초생활수급자·차상위계층에게 재가 월 6만 원(보장시설 월 3만 원)을 지급하는 제도입니다. 두 제도는 대상이 다르므로 중복 수급은 불가능합니다.',
    },
    {
      type: 'numbered-list',
      ...
      items: [
        ...
        '소득인정액: 단독가구 월 약 140만 원 이하, 부부가구 월 약 224만 원 이하 (2026년 기준 선정기준액)',
      ],
    },
    {
      type: 'info',
      heading: '지급 금액',
      body: '장애인연금은 기초급여와 부가급여로 구성됩니다. 기초급여는 소득 보장을 위한 것으로 [[basic-pension-application|기초연금]]과 동일한 금액(최대 월 349,700원)이며, 부가급여는 장애로 인한 추가 비용을 보전하기 위한 것으로 수급 유형에 따라 월 3만~9만 원이 추가됩니다. 기초생활수급자인 경우 부가급여가 가장 높습니다.',
    },
    {
      type: 'warning',
    ...
    },
    {
      ...
      items: [
        ...
        '기초급여(최대 월 349,700원) + 부가급여(월 3~9만 원) 구성',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '장애 정도 재심사 결과 "장애 정도가 심하지 않은 장애인"으로 변경되면 장애인연금 수급 자격이 상실됩니다. 대신 소득 기준을 충족하면 장애수당(재가 월 6만·보장시설 월 3만 원)으로 전환될 수 있습니다. 재심사 결과에 이의가 있으면 통보일로부터 90일 이내에 국민연금공단에 이의신청할 수 있습니다.',
    },
    {
      question: '부부가 모두 중증 장애인이면 각각 받을 수 있나요?',
      answer:
        '네, 부부 모두 중증 장애인이고 각각 소득인정액 기준을 충족하면 개인별로 장애인연금을 받을 수 있습니다. 다만 부부가구의 소득인정액 기준(월 약 224만 원)은 단독가구 기준의 1.6배로 적용되므로, 부부 합산 소득이 이 기준을 초과하면 수급이 어려울 수 있습니다. 정확한 계산은 국민연금공단(☎ 1355)에서 확인하세요.',
    },
  ],
