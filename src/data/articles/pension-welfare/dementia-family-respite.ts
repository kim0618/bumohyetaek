  ...
  sections: [
    {
      ...
      body: '부모님이 밤마다 배회하고, 식사를 거부하고, 같은 말을 수십 번 반복하실 때 - 가족의 하루는 24시간 비상 상태가 됩니다. 치매 환자를 돌보는 가족 중 약 40%가 우울 증상을 겪고 있습니다. 돌봄 가족이 지치면 환자의 돌봄 질도 함께 떨어집니다. 이 악순환을 끊을 수 있는 제도가 있습니다. 치매가족 휴가제는 연간 최대 6일간 단기보호시설에 환자를 맡기고 가족이 쉴 수 있게 해주는 정부 지원입니다. [[dementia-care-center|치매안심센터]]에 등록된 환자라면 소득 무관, 누구나 신청 가능합니다.',
    },
    {
      type: 'info',
