...
const article: ContentItem = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: '6일을 한 번에 사용하지 않아도 됩니다. 1일 단위로 나누어 월 1회씩 쓰는 가족이 많습니다. 가족 행사나 건강검진 일정에 맞춰 미리 예약해 두는 것이 좋습니다. 또한 치매안심센터에서는 휴가제 외에도 가족 교육, 자조 모임, 심리 상담 프로그램을 무료로 운영합니다. [[senior-customized-care|노인맞춤돌봄서비스]]와 병행하면 돌봄 공백을 더 효과적으로 줄일 수 있습니다. 신청은 이용 희망일 기준 최소 2주 전에 하는 것이 안전합니다.',
    },
    {
      type: 'warning',
