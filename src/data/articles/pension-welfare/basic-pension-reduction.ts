  ...
  sections: [
    {
      type: 'text',
      heading: '기초연금 감액이란?',
      body: '[[basic-pension-application|기초연금]]은 만 65세 이상 소득 하위 70% 어르신에게 지급하지만, 특정 조건에 해당하면 기준 금액보다 적게 받게 됩니다. 감액에는 크게 두 가지 유형이 있습니다. 첫째는 국민연금 수령액과 연계하여 줄이는 연계 감액이고, 둘째는 부부가 함께 받을 때 적용하는 부부 감액입니다. 두 감액이 동시에 적용될 수도 있습니다.',
    },
    {
      type: 'list',
