...
const article: ContentItem = {
  ...
  seoDescription:
    '장기요양 수급자는 연간 160만 원 한도에서 복지용구(휠체어·전동침대·지팡이 등)를 본인 부담 15%만 내고 구입하거나 대여할 수 있습니다. 품목별 구분과 신청 절차를 신청 전 확인하세요.',
  ...
  sections: [
    {
      ...
      body: '[[long-term-care-grade|장기요양 등급]]을 받으셨는데 복지용구가 있다는 사실 자체를 모르는 경우가 많습니다. 방문요양 신청하느라 바빠서, 또는 어차피 지팡이 하나 쓰면 될 것 같아서 신청을 미루셨다면 서두르는 게 좋습니다. 복지용구 연간 160만 원은 방문요양·방문목욕 등에 쓰이는 월 한도액과 전혀 별개로 주어지는 급여입니다. 매달 방문요양을 한도 꽉 채워 이용해도 복지용구 160만 원은 그대로 남아있습니다. 쓰지 않으면 그해 말에 소멸하므로, 등급을 받았다면 필요한 품목이 있는지 지금 바로 확인해보세요.',
    },
    {
      type: 'list',
  ...
  faq: [
    ...
    {
      question: '복지용구 급여와 건강보험 보조기기 지원은 같은 제도인가요?',
      answer:
