...
const article: ContentItem = {
  ...
  sections: [
    {
      ...
      body: '국가유공자법에 따라 독립운동, 6·25전쟁, 베트남전쟁, 국가 안보 등에 기여하신 분과 그 유가족은 국가유공자로 등록하여 다양한 지원을 받을 수 있습니다. [[basic-pension-application|기초연금]]과 함께 보훈 급여를 받을 수 있으며, 두 혜택을 중복 수령하는 것도 가능합니다.',
    },
    {
      type: 'list',
  ...
  faq: [
    ...
    {
      question: '참전 증빙 서류를 분실했을 때 어떻게 하나요?',
      answer: '국가기록원이나 병무청에서 복무 관련 기록을 발급받을 수 있습니다. 보훈청 담당자에게 상황을 설명하면 서류 발급 방법을 안내받을 수 있습니다. ☎ 1811-1811로 먼저 문의하세요.',
    },
    {
