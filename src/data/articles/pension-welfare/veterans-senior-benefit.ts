...
const article: ContentItem = {
  ...
  officialSources: [
    { name: '국가보훈처', url: 'https://www.mpva.go.kr', note: '국가유공자 등록 및 혜택 안내 · ☎ 1811-1811' },
  ...
  sections: [
    ...
    },
    {
      ...
      body: '많은 어르신이 국가유공자 자격이 있음에도 등록하지 않아 혜택을 받지 못하고 있습니다. 6·25전쟁 참전 어르신, 베트남전 참전 어르신이라면 꼭 보훈청에 문의하세요. 이미 돌아가신 분의 경우 유족이 사후 등록을 신청할 수도 있습니다. ☎ 1811-1811로 문의하세요.',
    },
  ],
