...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '2020년 6개 사업 통합, 매년 50만 명 이상이 이용하는 무료 돌봄 서비스',
      body: '노인맞춤돌봄서비스는 2020년 기존 6개 노인돌봄사업을 통합해 출범한 국가 사회서비스로, 매년 50만 명 이상의 취약 노인이 이용하고 있습니다. 만 65세 이상 독거 어르신 또는 돌봄이 필요한 어르신이라면 장기요양등급이 없어도 신청할 수 있고, 안전확인·생활지원·사회참여·긴급지원이 맞춤형으로 제공됩니다. 더 자세한 전체 서비스 개요는 [[elderly-care-service|노인 돌봄서비스 안내]]에서 확인할 수 있습니다.',
    },
    {
      type: 'list',
      heading: '서비스 대상',
  ...
  faq: [
    ...
    {
      question: '지방에 계신 부모님을 위해 타 지역에서 신청할 수 있나요?',
      answer: '노인맞춤돌봄서비스는 어르신의 거주지 읍·면·동 주민센터에 신청해야 합니다. 자녀가 다른 지역에 살아도 부모님 거주지 주민센터에 전화나 방문으로 대리 신청이 가능합니다. 신청 전 보건복지상담센터(☎ 129)에서 사전 안내를 받으면 서류 준비가 더 수월합니다.',
    },
  ],
