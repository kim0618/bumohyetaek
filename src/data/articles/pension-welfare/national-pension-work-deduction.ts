  ...
  sections: [
    {
      ...
      body: '국민연금을 수령하면서 파트타임 일을 하거나 소규모 사업을 유지하고 싶은데 연금이 깎일까봐 망설이시는 분들이 많습니다. 핵심만 말씀드리면, 월 소득이 A값(2026년 기준 약 309만 원) 이하라면 감액 없이 전액 받을 수 있습니다. 그리고 65세가 되면 소득이 아무리 많아도 감액이 사라집니다. 감액 구조를 미리 이해해두면 일과 연금을 함께 계획하는 것이 훨씬 수월해집니다. [[national-pension-timing|국민연금 수급 시기]]와 함께 계획을 세우면 감액을 최소화할 수 있습니다.',
    },
    {
      type: 'info',
      heading: '재직자 감액이 적용되는 조건',
      body: '노령연금 수급자가 사업소득 또는 근로소득이 있는 업무에 종사하면서, 해당 소득이 A값을 초과하는 경우 감액이 적용됩니다. 2025년 7월부터 2026년 6월까지 적용되는 A값은 3,089,062원(약 309만 원)입니다. A값은 매년 국민연금공단이 고시하며 소폭 상승하는 경향이 있습니다. 이자·배당소득, 연금소득, 양도소득, 퇴직소득은 감액 대상 소득에 포함되지 않습니다. 반면 부동산 임대소득은 2015년 7월 시행령 개정 이후 사업소득의 일종으로 감액 대상에 포함됩니다. 감액이 적용되는 기간은 노령연금 수급 개시 후 최대 60개월(5년)입니다.',
    },
    {
      type: 'list',
