  ...
  sections: [
    {
      ...
      body: '상속은 예고 없이 찾아옵니다. 준비 없이 갑작스럽게 맞이하면 재산 파악에만 수개월이 걸리고, 형제간 분쟁으로 이어지는 경우도 많습니다. 지금 부모님과 함께 재산 목록을 정리하고 뜻을 확인해두는 것만으로도 큰 분쟁을 예방할 수 있습니다. 치매가 진행되기 전에 준비하는 것이 중요하며, [[adult-guardianship|성년후견제도]]나 임의후견계약도 함께 고려하세요.',
    },
    {
      type: 'numbered-list',
