...
const article: ContentItem = {
  ...
  relatedSlugs: ['housing-pension-type-comparison', 'housing-farmland-pension-comparison', 'senior-home-disposal-comparison', 'retirement-finance-checklist', 'farmland-pension'],
  relatedCalculator: {
