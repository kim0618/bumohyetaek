...
const article: ContentItem = {
  ...
  sections: [
    {
      ...
      body: '결론부터 말씀드리면, 건강하고 자립 가능하다면 실버타운·노인복지주택, 돌봄이 필요하다면 요양원을 선택하는 것이 맞습니다. 노인 주거는 크게 스스로 생활 가능한 자립형과 돌봄이 필요한 요양형으로 나뉩니다. 자립형에는 민간 실버타운, 노인복지주택, 공공실버주택이 있고, 요양형에는 노인요양시설(요양원)과 노인요양공동생활가정이 있습니다. [[long-term-care-grade|장기요양등급]]이 있으면 요양형 시설 입소가 유리합니다.',
    },
    {
      type: 'summary',
  ...
  faq: [
    ...
    {
      question: '실버타운 입주 계약 시 특히 주의해야 할 점은 무엇인가요?',
      answer: '보증금 환급 조건을 가장 먼저 확인하세요. 일부 시설은 거주 기간에 따라 보증금 일부를 차감하거나, 환급까지 수개월이 걸리는 경우가 있습니다. 중도 퇴소 시 위약금 조항, 월 이용료 인상 상한, 의료비 별도 청구 방식도 꼼꼼히 살펴봐야 합니다. 계약서를 법무사나 변호사에게 검토받는 것도 좋습니다. 문의: ☎ 129 (보건복지상담센터).',
    },
  ],
