  ...
  sections: [
    {
      ...
      body: '전세사기는 보증금 수억 원을 한꺼번에 잃을 수 있는 심각한 피해입니다. 특히 어르신은 부동산 서류 확인에 익숙하지 않아 피해를 입기 쉽습니다. 자녀가 함께 계약 과정에 참여하고, 아래 체크리스트를 하나씩 확인하면 대부분의 전세사기를 예방할 수 있습니다. 부모님 주거 선택을 고민 중이라면 [[senior-housing-guide|노인 주거 가이드]]도 참고하세요.',
    },
    {
      type: 'numbered-list',
