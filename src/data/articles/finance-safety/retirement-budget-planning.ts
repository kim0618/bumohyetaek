...
const article: ContentItem = {
  ...
  sections: [
    ...
    },
    {
      type: 'info',
      heading: '핵심 수치 정리',
      body: '은퇴 후 필요 생활비(부부 기준): 최소 198만 원 / 적정 277만 원 / 의료비 포함 시 300만 원 이상. 국민연금 평균 수령액: 월 65만 원. 기초연금(소득 하위 70%): 최대 약 35만 원. 두 연금 합산 최대 약 100만 원으로, 적정 생활비와의 격차는 약 180만 원 이상입니다. 이 격차를 퇴직연금·개인연금·근로소득으로 메워야 합니다. 문의: ☎ 1332 (금융감독원 무료 재정 상담)',
    },
    {
      type: 'list',
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '현실적으로 어렵습니다. 국민연금 평균 수령액은 월 65만 원(2026년 기준) 수준으로, 적정 노후 생활비 277만 원의 약 23%에 불과합니다. 기초연금(최대 약 35만 원)을 더해도 약 100만 원 수준에 불과합니다. 나머지는 퇴직연금, 개인연금(IRP·연금저축), 근로소득, 금융소득으로 채워야 합니다. 지금 당장 부족하다면 노인일자리 사업(☎ 1577-1000) 참여나 주택연금 가입도 검토해보세요.',
    },
  ],
  ...
  relatedSlugs: ['retirement-preparation-checklist-guide', 'housing-pension', 'farmland-pension', 'national-pension-timing', 'national-pension-increase-strategy'],
};
