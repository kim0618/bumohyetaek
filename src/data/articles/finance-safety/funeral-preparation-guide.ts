...
const article: ContentItem = {
  ...
  sections: [
    {
      ...
      body: '밤늦게 부모님이 갑자기 위독해졌다는 연락을 받았을 때, 무엇을 먼저 해야 할지 알고 계신가요? 슬픔 속에서도 사망진단서 발급, 장례식장 선정, 사망신고 등 처리해야 할 일들이 빠르게 이어집니다. 병원에서 임종한 경우 병원에서, 자택이나 요양원에서 임종한 경우 의사나 119를 통해 사망 확인 후 사망진단서를 받습니다. [[after-death-admin|사망 후 행정처리]] 전체 절차와 함께 준비해두면 가족이 고인을 잘 보내는 데 집중할 수 있습니다.',
    },
    {
      type: 'numbered-list',
      heading: '장례 진행 순서',
    ...
    },
    {
      ...
      body: '국민기초생활보장법에 따라 기초생활수급자 가구원이 사망하면 장제급여를 받을 수 있습니다. 1인당 최대 80만 원(2026년 기준) 지급. 사망일로부터 1년 이내 주민센터에 신청하면 됩니다.',
    },
    {
      type: 'numbered-list',
  ...
  relatedSlugs: ['senior-expense-review-guide', 'survivor-pension', 'inheritance-gift-planning', 'dementia-inheritance-protection-guide'],
};
