...
const article: ContentItem = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: '도서·벽지나 천재지변 등 시설 이용이 어려운 특수 상황에서 가족이 직접 수급자를 돌보면 「가족요양비」(특별현금급여)를 월 약 23만 원(2025년 기준 233,400원) 받을 수 있습니다. 일반적인 동거 돌봄이 아닌, 보건복지부 장관이 인정한 특정 사유에 한해 지급됩니다. 한편 요양보호사 자격증을 취득한 가족이 재가 서비스를 제공하는 「가족인 요양보호사」 방식은 기관을 통해 별도 급여를 받는 구조입니다. 신청·문의는 ☎ 1577-1000(국민건강보험공단 장기요양 콜센터).',
    },
    {
      type: 'tip',
  ...
  faq: [
    ...
    {
      question: '장기요양 등급 신청 시 의사 소견서가 꼭 필요한가요?',
      answer:
