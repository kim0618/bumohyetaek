...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '연금이 많을수록 세금도 비례해 많다고 생각하기 쉽지만',
      body: '연금 수령액이 늘수록 세금 부담도 비례해 커진다고 생각하는 분이 많습니다. 실제로는 연금 종류와 수령 방식을 잘 선택하면 상당히 낮은 세율로 관리할 수 있습니다. 사적연금(개인연금·IRP)은 연간 1,500만 원 이하라면 3~5%의 저율 분리과세를 선택할 수 있고, 국민연금은 연 516만 원까지는 세금이 없습니다. [[national-pension-timing|국민연금 수령 시기]]와 [[retirement-pension-irp|퇴직연금·IRP]] 수령 방식을 전략적으로 설계하면 세 부담을 크게 줄일 수 있습니다.',
    },
    {
      type: 'info',
  ...
  relatedSlugs: ['pension-savings-tax-benefit', 'national-pension-timing', 'retirement-pension-irp', 'pension-income-sequence'],
