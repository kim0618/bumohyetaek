...
const article: ContentItem = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: '①기초연금 신청: 만 65세 생일월에 주민센터 또는 복지로에서 신청. 늦어도 1~2개월 내 처리. [[basic-pension-application|기초연금 신청 안내]] 참고. ②노인장기요양보험 피보험자 자동 편입(별도 신청 불필요). ③경로우대 혜택 자동 적용 시작(교통·문화·공중목욕 할인). ④건강보험 피부양자 자격 재점검 - 연소득 2,000만원, 재산 과세표준 9억원 기준 초과 시 지역가입자 전환됨. ⑤노인 일자리 프로그램 신청 가능 연령 진입(공익활동형 월 27만원, 사회서비스형 월 76만원). 문의: ☎ 129 (보건복지상담), ☎ 1355 (국민연금)',
    },
    {
      type: 'list',
