...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '결론부터 말하면, 대부분 연금 수령이 일시금보다 유리합니다',
      body: '퇴직금을 한꺼번에 받으면 퇴직소득세 전액이 부과됩니다. 반면 연금으로 나눠 받으면 퇴직소득세의 60~70%만 납부하면 됩니다. 10년 초과 수령 시에는 40%가 절감됩니다. 예를 들어 퇴직소득세가 300만 원이라면 연금으로 10년 초과 수령 시 180만 원만 납부합니다. 퇴직금 규모가 클수록 절세액도 커집니다. [[national-pension-lump-sum|국민연금 수령 시기]]와 함께 노후 소득 계획을 세워두는 것이 좋습니다.',
    },
    {
      type: 'info',
      heading: '퇴직연금 종류 - DB·DC·IRP',
      body: 'DB형(확정급여형)은 회사가 운용하며 퇴직 시 약정된 급여를 받습니다. DC형(확정기여형)은 근로자가 직접 운용하며 운용 성과에 따라 수령액이 달라집니다. IRP(개인형 퇴직연금)는 이직·퇴직 시 퇴직금을 이전하거나 개인이 추가 납입하는 계좌입니다. 어떤 유형이든 IRP 계좌로 옮긴 뒤 연금 또는 일시금으로 수령합니다.',
    },
    {
      type: 'list',
      heading: '연금 수령 조건',
    ...
    {
      type: 'info',
      heading: '신청 서류와 처리 기간',
      body: '연금 수령 신청 시 필요한 서류: 신분증, 퇴직금 수령 확인서, 통장 사본(IRP 계좌), 퇴직소득 원천징수영수증. 가입 금융기관 앱에서도 신청 가능하며, 처리 기간은 통상 신청 후 14일 이내입니다. 문의: 가입 금융기관 고객센터 또는 금융감독원 민원상담 ☎ 1332.',
    },
  ],
  ...
  faq: [
    {
      ...
      answer: '금융감독원 통합연금포털(100lifeplan.fss.or.kr)에서 본인의 모든 퇴직연금·연금저축 현황을 한번에 조회할 수 있습니다. 공동인증서로 로그인하면 확인 가능합니다. 퇴직연금과 연금저축을 함께 조회할 수 있어 통합 관리에 편리합니다.',
    },
    {
      question: '연금 수령 중 사망하면 남은 금액은 어떻게 되나요?',
      answer: '남은 잔액은 상속인에게 승계되며, 상속인이 일시금 또는 연금으로 수령할 수 있습니다. 이때 퇴직소득세 혜택이 적용된 금액에 대해서는 세금 정산이 이뤄집니다. 상속 처리 방식은 가입 금융기관에 사전에 확인해두는 것이 좋습니다.',
    },
    {
      question: '일시금이 무조건 불리한가요?',
      answer: '꼭 그렇지는 않습니다. 퇴직소득세 자체가 적거나(납입 기간이 짧거나 퇴직금이 소액인 경우), 당장 큰 자금이 필요한 경우에는 일시금이 합리적일 수 있습니다. 세금 계산 후 비교해보세요. 금융감독원 통합연금포털에서 수령 방식별 예상 세금을 시뮬레이션해볼 수 있습니다.',
    },
  ],
  ...
  relatedSlugs: ['pension-savings-tax-benefit', 'irp-pension-savings-comparison', 'retirement-finance-checklist', 'housing-pension', 'senior-annuity-insurance'],
};
