...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '노인 세금 감면 제도 개요',
      body: '대한민국 세법과 지방세특례제한법은 65세 이상 어르신을 위한 다양한 세금 감면 제도를 두고 있습니다. 소득세·재산세·자동차세·취득세 등 다양한 세목에서 혜택을 받을 수 있으며, 대부분 별도 신청이 필요합니다. [[pension-income-tax|연금소득세]] 절세 전략과 함께 활용하면 세 부담을 크게 줄일 수 있습니다.',
    },
    {
      type: 'list',
