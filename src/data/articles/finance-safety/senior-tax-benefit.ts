...
const article: ContentItem = {
  ...
  keyPoints: [
    '70세 이상이면 소득세 기본공제(1인 150만 원) 외에 경로우대 추가공제 100만 원 적용',
  ...
  relatedSlugs: ['parent-dependent-deduction-sibling', 'pension-savings-tax-benefit', 'pension-income-tax', 'inheritance-gift-planning', 'medical-expense-deduction', 'home-sale-tax-exemption'],
};
