...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '모바일뱅킹 vs 은행 방문, 어느 쪽이 더 안전할까',
      body: '모바일뱅킹이 위험하니 은행에 직접 가는 게 안전할까요, 아니면 제대로 설정하면 모바일이 더 편리하고 안전할까요. 답부터 말하면 보안 설정을 제대로 해둔 모바일뱅킹이 대면 거래만큼 안전합니다. 문제는 설정을 하지 않거나, 문자 링크를 통한 악성 앱 설치, 가짜 은행 앱 유도, 원격제어 앱(팀뷰어 등)을 통한 계좌 탈취에 당하는 경우입니다. [[smishing-prevention|스미싱 문자 사기]] 피해도 함께 주의해야 합니다.',
    },
    {
      type: 'numbered-list',
    ...
    {
      type: 'warning',
      heading: '이런 전화·문자는 대부분 사기입니다',
      body: '"검찰입니다, 계좌가 범죄에 연루되었습니다", "은행 보안팀입니다, 앱을 업데이트해야 합니다", "택배 주소 확인 바랍니다 [링크]" - 이런 연락은 거의 대부분 사기입니다. 공공기관이나 은행은 전화로 앱 설치나 비밀번호를 요구하지 않습니다. 의심 전화를 받으면 일단 끊고 ☎ 112 또는 ☎ 1332(금융감독원)에 확인하세요.',
    },
    {
      type: 'summary',
      heading: '핵심 요약',
  ...
  faq: [
    ...
    {
      question: '모바일뱅킹 비밀번호를 잊어버렸을 때 어떻게 하나요?',
      answer:
        '뱅킹 앱 로그인 화면에서 "비밀번호 재설정"을 누르면 본인 인증 후 새 비밀번호를 설정할 수 있습니다. 본인 인증이 어려우면 은행 고객센터에 전화하거나 가까운 영업점을 방문하세요. 이때 반드시 통장이나 카드 뒷면에 적힌 공식 번호로 연락하고, 인터넷 검색으로 나온 전화번호는 사기일 수 있으니 주의하세요.',
    },
  ],
