...
const article: ContentItem = {
  ...
  sections: [
    ...
    {
      type: 'warning',
      heading: '이런 전화·문자는 100% 사기입니다',
      body: '"검찰입니다, 계좌가 범죄에 연루되었습니다", "은행 보안팀입니다, 앱을 업데이트해야 합니다", "택배 주소 확인 바랍니다 [링크]" - 이런 연락은 모두 사기입니다. 공공기관이나 은행은 전화로 앱 설치나 비밀번호를 요구하지 않습니다. 의심 전화를 받으면 일단 끊고 ☎ 112 또는 ☎ 1332(금융감독원)에 확인하세요.',
    },
    {
      type: 'summary',
      heading: '핵심 요약',
