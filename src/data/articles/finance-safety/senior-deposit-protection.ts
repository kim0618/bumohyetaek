...
const article: ContentItem = {
  ...
  sections: [
    {
      type: 'text',
      heading: '예금자보호제도란?',
      body: '예금자보호법에 따라 은행·저축은행·보험사 등이 파산하더라도 1개 금융기관당 최대 5,000만 원(원금+이자 합산)까지 국가가 보장해줍니다. 부모님 노후 자금이 5,000만 원을 초과한다면 여러 금융기관에 나눠 예치해야 전액 보호받을 수 있습니다. [[retirement-budget-planning|노후 예산 계획]]과 함께 자금 운용 전략을 세워보세요.',
    },
    {
      type: 'list',
  ...
  faq: [
    ...
    {
      question: '저축은행 예금도 안전한가요?',
      answer:
        '저축은행도 예금자보호 대상이므로 5,000만 원까지는 보호됩니다. 다만 일반 은행에 비해 건전성 위험이 상대적으로 높으므로 금융감독원의 저축은행 통합 공시(sb.fss.or.kr)에서 해당 저축은행의 BIS 비율, 연체율 등을 확인하고 이용하세요.',
    },
  ],
