  ...
  sections: [
    {
      ...
      body: '기대수명이 늘어나면서 은퇴 후 20~30년의 생활비가 필요해졌습니다. 국민연금연구원에 따르면 노후에 부부 기준 월 최소 240만 원, 적정 수준은 340만 원 이상이 필요한 것으로 조사됩니다. 그러나 실제로 국민연금만으로 이 금액을 충당하기는 어렵습니다. 지금 재정 상황을 정확히 파악해야 부족한 부분을 미리 보완할 수 있습니다. 특히 예상치 못한 의료비나 돌봄 비용이 생기면 준비된 자금이 빠르게 소진될 수 있으므로, 연금 수령액, 저축, 보험, 부채, 비상금 5가지를 체계적으로 점검하는 것이 중요합니다. [[basic-pension-application|기초연금]]이나 [[survivor-pension|유족연금]] 수급 여부도 함께 확인해보세요.',
    },
    {
      type: 'numbered-list',
    ...
    {
      type: 'list',
      heading: '재정 현황 조회 시 필요한 서류',
      items: [
        '금융거래 확인서(금융감독원 파인 조회)',
        '국민연금 가입내역 확인서(국민연금공단)',
        '건강보험료 납부 확인서',
      ],
    },
    {
