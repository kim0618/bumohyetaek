...
const article: ContentItem = {
  ...
  faq: [
    ...
    {
      question: '퇴직 후 지역건강보험으로 전환되는데, 연금 수령이 보험료에 영향을 미치나요?',
      answer:
  ...
  sections: [
    {
      ...
      body: '퇴직 통보를 받고 인사팀에서 IRP 계좌번호를 요청하는 문자가 왔을 때, 어디서부터 시작해야 할지 막막한 경우가 많습니다. IRP에 넣은 뒤 바로 찾으면 일시금, 55세 이후 나눠 받으면 퇴직연금입니다. 두 선택지는 세금이 최대 40%까지 차이 납니다. [[retirement-pension-irp|퇴직연금·IRP 제도]]와 함께 이해하면 수령 방식 선택이 훨씬 명확해집니다.',
    },
    {
      type: 'list',
      heading: '일시금 수령 - 장단점',
    ...
    },
    {
      ...
      body: '퇴직소득세가 300만 원인 경우를 예로 들면: 일시금 수령 시 300만 원 전액 납부, IRP 연금 수령(10년 이하) 시 210만 원 납부(90만 원 절감), IRP 연금 수령(10년 초과) 시 180만 원 납부(120만 원 절감)입니다. 퇴직금 규모가 클수록 절세 효과도 커지므로 [[pension-income-tax|연금 소득 세금]] 전략과 함께 검토하시기 바랍니다.',
    },
    {
      type: 'numbered-list',
