...
const article: ContentItem = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        '확인이 필요합니다. 악성 앱이 설치된 경우 즉각적인 반응이 없어도 백그라운드에서 개인정보나 금융정보를 유출하고 있을 수 있습니다. 링크를 눌렀다면 즉시 와이파이와 데이터를 끄고, 스마트폰 백신 앱으로 검사하거나 필요 시 초기화하는 것이 안전합니다. 통신사 고객센터(☎ 114) 또는 한국인터넷진흥원(☎ 118)에 신고하면 악성 앱 감염 여부 확인과 대처 방법을 안내받을 수 있습니다.',
    },
    {
