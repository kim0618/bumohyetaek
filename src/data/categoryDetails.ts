...
장기요양보험은 65세 이상이거나 65세 미만이라도 치매·뇌혈관 질환 등으로 6개월 이상 혼자 일상생활이 어려운 경우 신청할 수 있습니다. 2026년 기준 등급별 재가급여 월 한도액은 1등급 2,512,900원, 2등급 2,331,200원, 3등급 1,528,200원, 4등급 1,409,700원, 5등급 1,208,900원, 인지지원등급 676,320원입니다. 본인부담은 재가급여 15%, 시설급여(요양원) 20%이며, 기초생활수급자는 면제됩니다.
