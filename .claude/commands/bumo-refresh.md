...
- **매월 초 (1~3일) 월 1회**: 10~12개 항목 회전 점검. ~50개 항목 / 10~12 = 약 4~5달에 한 바퀴. 월말이 아니라 **월초**인 이유: 정책은 거의 1일자 시행이라 월초 실행이 그 달 시행분을 즉시 캐치 (특히 7/1 A값). (제이퍼-refresh와 주기 통일)
- **매년 1월 첫째 주**: 모든 "연 1회" 항목 일제 점검 (정책 변경 집중 시기) - **연중 최우선 가동**
- **매년 7월 초**: 국민연금 A값 점검 (7/1 적용)
- **매년 8월**: 기준중위소득 점검 (8월 발표)
- **freeze 기간 무관**: 수치 정확성(YMYL)은 생산중단과 별개로 위 주기 유지
