...
**최종갱신: 2026-06-22** (출처: 네이버 서치어드바이저 검색어/웹문서 TOP 30)
...
7. 아버지 사망 후 그달 국민연금·미수령 연금 청구 (키워드 "아버지사망신고후 그달국민연금을 찾았는데" / survivor-pension·after-death 클러스터 보강)
...
고노출·저CTR 페이지를 네이버 검색어에 맞춰 제목 갱신. 변경 전 git으로 4주 쿨다운 확인:
- **여행지원금 클러스터 (최우선)** - 웹문서 seni… 116노출 CTR3.4 / 74노출 CTR0(클릭0!) / 58노출 CTR1.7. 검색어 "65세이상 여행지원금"(CTR50)·"섬여행지원금받는법"(CTR8.3)·"시니어 관광 바우처"·"시니어 여행바우처"를 제목 앞배치. 74노출 CTR0 페이지가 최대 누수
- **치매 클러스터** - dem… 59노출 CTR3.4 / 53노출 CTR1.9. "치매부모 통장관리"(37노출) 검색어 앞배치 (dementia-financial-management)
- national-pension 계열 (nati… 47노출 CTR2.1, 전월 1288→급감) - "국민연금 추납" 앞배치
- 홈(/) 54노출 CTR0, med… 31노출 CTR0, lone… 22노출 CTR0, care… 16노출 CTR0 - 노출만 있고 클릭0, 제목·메타 점검
