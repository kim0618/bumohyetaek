...
### Tier 1 - 네이버 검증된 승자 클러스터 (최우선)
1. 기초생활수급자 무료여행 자격과 신청 방법 (키워드 "기초생활수급자 무료여행"·"국내여행 지원 노인" / senior-travel-support 클러스터 - "시니어 여행지원금" 검색어 CTR 55%+ 강한 수요. 본문 페이지는 588노출인데 CTR 0.7%라 제목 최적화 병행 필요)
2. 노인 바우처 총정리 - 문화누리·에너지·사회서비스 비교 (키워드 "노인 바우처 종류" 52노출 / senior-social-service-voucher 클러스터)
3. 국민연금 추납 일시납 vs 분할납, 몇 세가 유리한가 (키워드 "국민연금 추납 일시납"·"추납 몇세에 납부가 유리" / national-pension 웹문서 1,288노출 클러스터)

### Tier 2 - 승자 클러스터 확장
4. 시니어 섬여행 지원금 - 대상 섬·신청 방법 (키워드 "시니어 섬여행지원금 신청")
5. 기초수급자 무료 의료서비스 총정리 (키워드 "기초수급자가 이용할 수 있는 무료 의료 서비스" / medical-aid-system 859노출 클러스터)
6. 국가유공자 부모 고령수당·부모연금 자격 (키워드 "국가유공자 고령수당 자격"·"국가유공자 부모연금" / veterans-senior-benefit 272노출)
7. 부모님 의료급여 신청 - 자녀 동의·부양의무자 기준 (키워드 "부모님 의료급여 신청"·"기초생활수급자 의료 자녀동의")
8. 지역별 국민연금 추납 신청처 안내 (키워드 "국민연금 추납 신청 어디서"·"성남시 국민연금추납하는곳")
9. 시니어 디지털 교육 프로그램 추천 (키워드 "시니어를 위한 디지털 교육 프로그램 추천" / senior-digital-education 클러스터)

### 제목 최적화 대상 (월 1회 /bumo-meta-optimize와 연계, 메타 쿨다운 4주 준수)
고노출·저CTR 페이지를 네이버 검색어에 맞춰 제목 갱신. 변경 전 git으로 4주 쿨다운 확인:
- national-pension 계열 (웹문서 /guide/nati… 1,288노출 CTR 2.7%) - "국민연금 추납" 검색어 앞배치
- medical-aid-system (/guide/med… 859노출 CTR 2.1%) - "기초수급자 의료혜택" 앞배치
- **senior-travel-support** (588노출 CTR 0.7%, 최우선) - "시니어 여행지원금"·"65세 이상 여행지원금" 검색어 앞배치
- /guide/care… 279노출 CTR 0.7% (URL 확인 필요)
- 키워드 레벨 고노출·저CTR: "노인 바우처 종류"(52노출 1.9%), "국가유공자 고령수당 자격"(44노출 2.3%)
