...
제이퍼 승인 후 이어질 부모혜택 애드센스 신청 대비. 103편 전체를 **YMYL 기준(의료 면책 + 정책 수치 정확성 + 공식 출처 신뢰성)**으로 교차 감사해 E-E-A-T 품질 확보.

## 실행 원칙

- 사용자 명시 없으면 **하루 4편** 감사
- **우선순위 × updatedAt 최신순** 2단 정렬로 대상 선정
- **병렬 Explore subagent 4개**로 교차 감사 (자기검증 편향 차단)
- 발견 이슈는 부모 Claude가 **직접 재확인 후 수정**
- 감사 완료 후 `verified-articles.md`에 기록해 재감사 방지
- 목표: 103편 1차 패스 완주 (103 ÷ 4 = 26일)
...
### Step 5: 상위 4편 선택 → 사용자에게 알림 후 감사 시작

## 감사 절차

### Step 1: 4개 글 병렬 감사 (Explore subagent 4개)
...
- 대상 slug가 전체 103편에 존재하는지 (grep으로 확인)
...
- 누적 감사 완료 X / 103 (Y%)
- **제이퍼 애드센스 승인 대기 상태** (신청일 2026-04-28 기준 D-?)
...
- **제이퍼 승인 전 부모혜택 애드센스 신청 시도 금지** - 제이퍼 성공 사례 축적 후 신청
